...
//angle of rotation
float xpos = 3, ypos = 3, zpos = 3, xrot = 0, yrot = 180;
...
static void draw_walls()
{
   ...
   glTexCoord2f(0,0); glVertex3f(-10,-2,-10);
   glTexCoord2f(1,0); glVertex3f(10,-2,-10);
   glTexCoord2f(1,1); glVertex3f(10,18,-10);
   glTexCoord2f(0,1); glVertex3f(-10,18,-10);
   glEnd();
   //  Wall 2
   glColor3f(1,1,1);
   glBindTexture(GL_TEXTURE_2D,texture[2]);
   ...
   glNormal3f( 0, 8, 0);
   glTexCoord2f(0,0); glVertex3f(10,-2,10);
   glTexCoord2f(1,0); glVertex3f(10,18,10);
   glTexCoord2f(1,1); glVertex3f(10,18,-10);
   glTexCoord2f(0,1); glVertex3f(10,-2,-10);
   glEnd();
   //  Roof
   ...
   glBegin(GL_QUADS);
   glNormal3f( 0, 8, 0);
   glTexCoord2f(0,0); glVertex3f(-10,18,10);
   glTexCoord2f(1,0); glVertex3f(-10,18,-10);
   glTexCoord2f(1,1); glVertex3f(10,18,-10);
   glTexCoord2f(0,1); glVertex3f(10,18,10);
   glEnd();
...
void display()
{
   ...
   //OBJECTS DRAWN BELOW:
   cube(1,1,1 , 0.5,0.5,0.5 , 0);
   triprism(-1,-1,-2 , 1,2,1, 0);   
   draw_walls(); 
...
int main(int argc,char* argv[])
{
   ...
   glutCreateWindow("Assignment 3 - William Anderson");
   //  Set callbacks
   ...
   glutIdleFunc(idle);
   //  Load textures
   texture[0] = LoadTexBMP("Carbon_02.bmp");
   texture[1] = LoadTexBMP("Carbon_01.bmp");
   texture[2] = LoadTexBMP("wood_01.bmp");
   texture[3] = LoadTexBMP("roof_01.bmp");
   texture[4] = LoadTexBMP("ground_01.bmp");
   texture[5] = LoadTexBMP("crate.bmp");
